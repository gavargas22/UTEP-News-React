		...
		<div class="tab-content utep-news-tab">
			<div role="tabpanel" class="tab-pane no-outline active" id="news">
				...
				<div class="bottom-btn">
					<a href="http://news.utep.edu"><p style="font-family:'Tungsten A', 'Tungsten B';font-size:30px;font-weight:700;text-transform:uppercase;color#ff8200;text-decoration:none;">More News</p></a>
				</div>
			</div>
