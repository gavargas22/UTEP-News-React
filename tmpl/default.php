  ...
  <div class="container-fluid center-tabs-background">
    <div class="container">
      <ul class="nav nav-tabs center-custom-nav-tabs hidden-xs hidden-sm visible-md visible-lg" role="tablist">
        ...
        <li role="presentation"><a href="http://engage.utep.edu" aria-controls="messages" role="tab" data-toggle="tab" class="home-information-tabs" onclick="location.href = 'http://engage.utep.edu/';">ENGAGE</a></li>
      </ul>
